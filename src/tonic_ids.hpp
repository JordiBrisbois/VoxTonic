...
// so scanning this whole list is cheap (~19 compares per buff entry, and only
// while the option is enabled).
inline constexpr std::array<std::uint32_t, 19> kKnownTonicIds {{
    17732, 20976, 24573, 25651, 28935, 34572, 37954, 38453, 50196,
    51219, 57740, 58417, 55397, 39339, 52798, 67254, 70230, 73215, 80128,
}};
